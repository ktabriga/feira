...
const images = {
  ...
  creditCard: require('../Images/cred-card.png'),
  creditCardWhite: require('../Images/credit-card-white.png'),
  debitCard: require('../Images/debit-card.png'),
  debitCardWhite: require('../Images/debit-card-white.png'),
  money: require('../Images/money.png'),
  moneyWhite: require('../Images/money-white.png'),
  func1: require('../Images/func1.png'),
  func2: require('../Images/func2.png'),
  func3: require('../Images/func3.png'),
  func4: require('../Images/func4.png'),
}
